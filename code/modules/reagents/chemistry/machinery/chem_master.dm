...
/obj/machinery/chem_master/Initialize(mapload)
	...
	if(condi)
		...
		production_modes[new_mode.mode_id] = new_mode
		new_mode = new /datum/chemical_production_mode/autoinjectors() //EDIT 220 - Нужно для добавления медипена
		production_modes[new_mode.mode_id] = new_mode //EDIT 220 - Нужно для добавления медипена
