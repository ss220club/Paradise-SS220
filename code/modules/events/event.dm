/datum/event_meta
	...
	var/min_player = 0 // SS220 EDIT - минимальное количество игроков для запуска

/datum/event_meta/New(event_severity, event_name, datum/event/type, event_weight, list/job_weights, is_one_shot = FALSE, min_event_weight = 0, max_event_weight = INFINITY, min_number_player = 0)
	name = event_name
