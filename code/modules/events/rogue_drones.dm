...
/datum/event/rogue_drone/announce()
	...
	GLOB.minor_announcement.Announce(msg, "СБОЙНЫЕ ДРОНЫ.")
...
/datum/event/rogue_drone/end()
	...
	if(num_recovered > drones_list.len * 0.75)
		GLOB.minor_announcement.Announce("Система контроля боевых дронов сообщает, что все единицы успешно вернулись на борт «Икара».", "СБОЙНЫЕ ДРОНЫ.")
	else
		GLOB.minor_announcement.Announce("Система контроля боевых дронов сообщает о потере всех боевых единиц, однако жертв не зарегистрировано.", "СБОЙНЫЕ ДРОНЫ.")
