...
/datum/event/traders/fake_announce()
	...
	if(SSsecurity_level.get_current_level_as_number() >= SEC_LEVEL_RED)
		GLOB.minor_announcement.Announce("Торговому шаттлу со станции Юпитер было отказано в разрешении на стыковку из-за повышенной угрозы безопасности на борту [station_name()].", "Запрос на стыковку шаттла торговцев отклонен.")
		return
	GLOB.minor_announcement.Announce("Торговый шаттл со станции Юпитер получил разрешение на стыковку в порту прибытия 4 [station_name()].", "Запрос на стыковку шаттла торговцев принят.")
