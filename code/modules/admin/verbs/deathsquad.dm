...
/client/proc/send_deathsquad()
	...
	var/mission = sanitize(copytext_char(input(src, "Please specify which mission the Deathsquad shall undertake.", "Specify Mission", "",), 1, MAX_MESSAGE_LEN))	// SS220 EDIT - ORIGINAL: copytext
	if(!mission)
