...
/turf/proc/recalculate_directional_opacity()
	var/current_opacity = directional_opacity
	if(opacity)
		directional_opacity = ALL_CARDINALS
		if(current_opacity != directional_opacity)
			reconsider_lights()
		return
	...
	for(var/am in opacity_sources)
		...
		if(opacity_source.flags & ON_BORDER)
			...
			directional_opacity = ALL_CARDINALS
			break
	if(current_opacity != directional_opacity && (current_opacity == ALL_CARDINALS || directional_opacity == ALL_CARDINALS))
