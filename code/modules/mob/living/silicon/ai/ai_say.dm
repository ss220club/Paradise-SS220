...
/mob/living/silicon/ai/verb/announcement_help()
	...
	dat += "Вот список слов, которые можно использовать для оповещения всех, кто на том же Z-уровне, что и вы<BR> \
	<UL><LI>Вы также можете кликать на слова для предпросмотра.</LI>\
	<LI>Вы можете использовать до 30 слов в одном оповещении.</LI>\
	<LI>Не используйте пунктуацию как обычно, если вы хотите паузу, то используйте точку или запятую, отделённую пробелами со всех сторон: 'Alpha . Test , Bravo'.</LI></UL>\
