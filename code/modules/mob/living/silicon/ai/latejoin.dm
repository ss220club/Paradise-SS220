...
/mob/living/silicon/ai/verb/wipe_core()
	...
	if(alert("ВНИМАНИЕ: Это действие незамедлительно очистит ваше ядро и превратит вас в призрака, удаляя вашего персонажа из раунда (похоже на крио и робохранилище). Вы уверены, что хотите это сделать?",
					"Очистка ядра", "Нет", "Нет", "Да") != "Да")
		return
	cryo_AI()
