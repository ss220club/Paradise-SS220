/datum/species/diona
	...
	У Дион нет централизованного правительства или родной планеты, большинство из них избегает дел в широкой галактике, предпочитая сосредоточиться на распространении своего вида.<br/><br/> \
