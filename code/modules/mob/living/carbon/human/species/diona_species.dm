/datum/species/diona
	...
	blurb = "Дионы - растениеподобные существа, состоящие из гештальта более мелких Нимф. \
	У Дион нет централизованного правительства на их родной планете, большинство из них избегает дел в широкой галактике, предпочитая сосредоточиться на религиозных, философских и научных учениях.<br/><br/> \
