/datum/species/unathi
	...
	Организовавшись в высококонкурентные феодальные королевства, Унатхи не имеют какого-либо широкомасштабного объединения, а их культура и история состоят из столетий внутренних конфликтов и борьбы.<br/><br/> \
	Несмотря на то, что кланы обладают значительными военными силами, межклановое соперничество и постоянные гражданские войны не позволяют Унатхам добиться большего на широкой галактической арене."
