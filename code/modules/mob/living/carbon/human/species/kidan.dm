/datum/species/kidan
	...
	blurb = "Киданы - существа, похожие на муравьев, обладающих жестким экзоскелетом и строго придерживающиеся профессиональных каст. \
	...
	вынуждая их пытаться бороться с оккупантами за свою независимость."
