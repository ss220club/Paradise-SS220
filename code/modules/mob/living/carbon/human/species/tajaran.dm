/datum/species/tajaran
	...
	blurb = "Таяран - вид гуманоидных всеядных млекопитающих, имеющих внешнее сходство с земными кошачьими, родом происходящие с богатой минералами арктической луны Адомай. \
	Они появились на галактической арене в результате обнаружения экспедиционным флотом проекта \"Новые Горизонты\", были преобразованы в ассоциацию с Человеко-Скреллианским Альянсом.<br/><br/> \
