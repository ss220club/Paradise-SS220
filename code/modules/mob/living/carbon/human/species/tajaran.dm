/datum/species/tajaran
	...
	blurb = "Таяран - вид гуманоидных всеядных млекопитающих, имеющих внешнее сходство с земными кошачьими, родом происходящие с богатой минералами планеты Адомай. \
