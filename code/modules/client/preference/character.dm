...
/datum/character_save/proc/SetChoices(mob/user, limit = 19, list/splitJobs = list("Head of Security", "Quartermaster"), widthPerColumn = 500, height = 750) // SS220 EDIT - tweak limit and widthPerColumn
	if(!SSjobs)
		return
