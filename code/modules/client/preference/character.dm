...
/datum/character_save/proc/save(client/C)
	...
	var/datum/db_query/query = SSdbcore.NewQuery({"
		INSERT INTO characters (ckey, slot, OOC_Notes, real_name, name_is_always_random, gender,
			...
			hair_gradient, hair_gradient_offset, hair_gradient_colour, hair_gradient_alpha, custom_emotes, tts_seed, cyborg_brain_type)
		VALUES
			...
			:h_grad_style, :h_grad_offset, :h_grad_colour, :h_grad_alpha, :custom_emotes, :tts_seed, :cyborg_brain_type)
	"}, list(
