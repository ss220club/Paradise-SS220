...
/datum/team/cult/proc/cult_fall()
	...
	if(!no_announcements)
		GLOB.major_announcement.Announce("Паранормальная активность вернулась к прежнему минимальному состоянию. \
									...
									Сотрудники, не связанные с службой безопасности, могут защищаться, но в первую очередь они должны покинуть зоны, где есть культисты, и сообщить о них в службу безопасности. \
