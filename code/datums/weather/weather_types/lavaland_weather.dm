...
/datum/weather/volcano
	...
	desc = "Смещение тектонических сил на планете вызвало вулканическую активность в этом районе. Образуются новые лавовые реки и бездонные пропасти, а с неба обрушатся обломки горных пород."

	telegraph_message = "<span class='boldwarning'><i>Земля под Вами дрожжит с пугающей силой, грозя расколоться и уйти вглубь планеты. Поскорее найдите укрытие.</i></span>"
	telegraph_duration = 600
	telegraph_sound = 'sound/weather/volcano/lavaland_volcano_warning.ogg'

	weather_message = "<span class='userdanger'><i>За горизонтом виден огромный столб дыма и пепла. Земля под Вами трясётся и грозит расколоться. Немедленно прячьтесь внутрь!</i></span>"
	weather_duration_lower = 600
	weather_duration_upper = 1200
...
/datum/weather/acid
	...
	desc = "Выбросы серы и углерода в атмосферу приводят к образованию кислотных частиц в облаках пепла. В конечном итоге их накапливается достаточно, чтобы сконденсироваться и выпасть обратно в виде сернокислотных дождей. К сожалению, шахтерские капсулы-убежища Нанотрейзен не рассчитаны на такую концентрацию кислоты."
