/datum/spell/disguise_self
	name = "Disguise Self"
	desc = "Замаскируйтесь под члена экипажа и измените свой голос, в зависимости от вашего текущего местоположения. Активация заклинания занимает две секунды, будучи неподвижным. Маскировка спадёт, если на вас нападут"
