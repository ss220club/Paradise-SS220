/datum/spell/infinite_guns
	...
	desc = "Зачем перезаряжаться, если у вас есть бесконечное количество пушек? Вызывает бесконечный поток винтовок с затвором. Для использования требуются свободные руки."
