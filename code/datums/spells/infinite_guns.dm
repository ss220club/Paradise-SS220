/datum/spell/infinite_guns
	...
	desc = "Зачем перезаряжаться, если у вас есть бесконечное количество пушек? Вызывает бесконечный поток винтовок с затвором. Для использования требуются свободные обе руки."
...
/datum/spell/infinite_guns/fireball
	...
	desc = "Шквал огненных шаров. Нужно ли объяснять подробнее? Для использования требуется, чтобы обе руки были свободны."
