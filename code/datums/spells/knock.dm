...
/datum/spell/aoe/knock/greater
	name = "Greater Knock"
	desc = "При первом использовании снимет ограничения доступа на всех шлюзах на станции и объявит об использовании экипажу. При любом последующем использовании откроет все шлюзы в поле зрения. Нельзя вернуть."
