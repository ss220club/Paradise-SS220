...
/mob/living/carbon/human/proc/makeCluwne()
	...
	to_chat(src, "<span class='danger'>Вы чувствуете себя слишком смешным со стороны.</span>")
...
/mob/living/carbon/human/proc/makeAntiCluwne()
	to_chat(src, "<span class='danger'>Вы чувствуете себя не очень-то весело.</span>")
	adjustBrainLoss(-120)
