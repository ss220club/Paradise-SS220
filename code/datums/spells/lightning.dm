/datum/spell/charge_up/bounce/lightning
	name = "Lightning Bolt"
	desc = "Метает молнии в ваших врагов. Классика. При нажатии начнет накапливаться энергия. Нажмите на цель, чтобы отправить заряд до того, как он переполнится и рассеется."
