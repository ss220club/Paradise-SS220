/datum/spell/touch/mime_malaise
	name = "Mime Malaise"
	desc = "Заклинание, популярное среди волшебников театра и просто проказников. Надевает на цель костюм мима, заставляет замолчать и оглушает, чтобы он мог созерцать искусство."
