/datum/spell/conjure_item
	name = "Summon weapon"
	desc = "Универсальное заклинание, которого не должно существовать. Вызывает экземпляр предмета определенного типа, или, если он уже существует, отменяет его вызов."
	clothes_req = FALSE
	var/obj/item/item
