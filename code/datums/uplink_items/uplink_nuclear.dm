...
/datum/uplink_item/dangerous/rocket_launcher
	...
	desc = "Никто не доживёт до завтра, ведь с нами непревзойдённая и не имеющая в разрушениях равных - Ракетная установка! \
...
/datum/uplink_item/suits/shielded
	...
	Энергощит — это, по сути, уменьшенная версия тех продвинутых дефлекторных экранов, что заметны на военных шаттлах. \
...
/datum/uplink_item/cyber_implants/reviver
	...
	desc = "Автоимплантер, содержащий экранированный имплант возрождения. Имплант будет ускорять заживление лёгких ран, \
	если сработает датчик критического состояния организма. В случае утраты организмом биологической активности \
	продолжит в автоматическом режиме восстанавливать его и при остатке лишь малых ран - попытается запустить сердце субъекта. \
