...
/datum/uplink_item/jobspecific/clownslippers
	name = "Акробатические сапоги клоуна"
...
/datum/uplink_item/jobspecific/cmag
	name = "Джестографический шифратор"
...
/datum/uplink_item/jobspecific/caneshotgun
	name = "Трость-дробовик и патроны для убийств"
...
/datum/uplink_item/jobspecific/pressure_mod
	name = "Модуль Давления на Кинетический Акселератор"
...
/datum/uplink_item/jobspecific/specialsauce
	name = "Специальный соус Превосходства Шефа"
...
/datum/uplink_item/jobspecific/missionary_kit
	name = "Комплект начинающего миссионера"
...
/datum/uplink_item/jobspecific/drunkbullets
	name = "Опьяняющие патроны на дробовик"
...
/datum/uplink_item/jobspecific/ambrosiacruciatus
	name = "Семена Амброзия Круциатус"
...
/datum/uplink_item/jobspecific/magillitis_serum
	name = "Био-чип с сыворотком Магиллитис"
...
/datum/uplink_item/species_restricted/supercharge_implant
	name = "Био-чип синтетического суперзаряда"
...
/datum/uplink_item/species_restricted/fireproofing_nanites
	name = "Инъектор огнеупорных нанитов"
...
/datum/uplink_item/species_restricted/prescan
	name = "Продвинутая система клонирования от Технократии"
...
/datum/uplink_item/stealthy_tools/traitor_belt
	name = "Пояс с инструментами Предателя"
...
/datum/uplink_item/stealthy_tools/voice_modulator
	name = "Хамелеон маска с модулятором голоса"
...
/datum/uplink_item/stealthy_weapons/combat_minus
	name = "Экспериментальные Крав перчатки"
...
/datum/uplink_item/suits/modsuit_elite
	name = "Элитный МОДСьют Синдиката"
...
/datum/uplink_item/bundles_TC/contractor
	name = "Набор контрактника Синдиката"
...
/datum/uplink_item/bundles_TC/contractor/spawn_item(turf/loc, obj/item/uplink/U)
	...
	if(LAZYACCESS(GLOB.contractors, mind))
		to_chat(usr, "<span class='warning'>Ошибка: Обнаружены учётные данные контрактника для текущего пользователя. Невозможно выдать ещё один набор Контрактника.</span>")
		return
	else if(!AT)
		to_chat(usr, "<span class='warning'>Ошибка: Не обнаружены учётные данные Синдиката.</span>")
		return
	else if(ischangeling(usr) || mind.has_antag_datum(/datum/antagonist/vampire))
		to_chat(usr, "<span class='warning'>Error: Поставленные учётные данные Синдиката имеют абнормальную сигнатуру. Отмена.</span>")
		return
...
/datum/uplink_item/bundles_TC/surplus_crate
	name = "Ящик с излишками Синиката"
...
/datum/uplink_item/explosives/atmosfiregrenades
	name = "Плазменные огненные гранаты"
...
/datum/uplink_item/stealthy_tools/syndigaloshes
	name = "Нескользящие туфли Хамелеон"
...
/datum/uplink_item/explosives/detomatix
	name = "Картридж для ПДА \"Detomatrix\""
