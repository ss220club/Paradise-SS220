...
/datum/uplink_item/species_restricted/supercharge_implant
	...
	desc = "Био-чип, устанавливаемый под внешнюю часть корпуса. При активации вводит химический коктейль из реагентов, которые \
...
/datum/uplink_item/stealthy_weapons/sleepy_pen
	...
	// name = "Sleepy Pen"
	desc = "Шприц, замаскированный под функциональную ручку, наполненный мощным снотворным. Ручка содержит две дозы смеси. \
...
/datum/uplink_item/cyber_implants/sensory_enhancer
	...
	чувствительности к боли, заставит вас не сдаваться даже будучи сбитым с ног и ускорит вашу мелкую моторику рук, но не спасёт вас от \
...
/datum/uplink_item/bundles_tc/contractor
	...
	desc = "Набор, дающий вам разрешение на выполнение особых поручений по похищению, в обмен на кредиты и дополнительные телекристаллы.\
