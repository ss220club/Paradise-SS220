...
/datum/uplink_item/dangerous/pistol
	...
	desc = "Небольшой, легко скрываемый пистолет, использующий патроны калибра 10мм в магазинах на 8 патронов. Имеет \
			 насечку на стволе для глушителя."
...
/datum/uplink_item/dangerous/rapid
	...
	desc = "Перчатки позволяют с невероятной скоростью совершать обычные действия вроде толкания и избивания жертвы, но так же \
			 работают и на поглаживания. Работают только на безоружные атаки. Могут использоваться в сочетании с боевыми искусствами для непобедимой комбинации."
	reference = "RPGD"
...
/datum/uplink_item/dangerous/sword
	name = "Световой меч"
	desc = "Холодное оружие с большим уроном и лезвием из чистой энергии. Меч настолько мал, поэтому его можно положить \
			 в карман в неактивном состояние. При активации издается громкий и характерный звук. С большой вероятностью отражает лазерные снаряды."
	reference = "ES"
...
/datum/uplink_item/dangerous/dsword
	...
	desc = "Световой меч с двойным лезвием, что может быть ещё лучше? Наносит чуть больший урон, чем обычный энергетический \
			 меч. Автоматически отражает все виды лазерных снарядов. Ударяет нападавшего в ответ при ударе пользователя в режиме парирования."
	reference = "DSRD"
...
/datum/uplink_item/dangerous/powerfist
	...
	desc = "Силовой кулак представляет собой металлическую перчатку со встроенным ударным поршнем, работающим от внешнего \
			 источника газа. При попадании в цель поршень выдвигается вперед и наносит серьезный урон, отталкивая цель. С помощью гаечного ключа вы сможете регулировать количество газа, расходуемого на удар, повышая наносимый урон и отталкивая цели с большей силой. С помощью отвертки можно снять баллон."
	reference = "PF"
...
/datum/uplink_item/dangerous/chainsaw
	...
	desc = "Чрезвычайно смертоносное и громкое оружие. Она не может храниться в рюкзаке и издает очень громкий шум, \
			 когда включена. Разрывает трупы на куски мяса, не оставляя ничего для клонирования. Заведя пилу, её более никто не сможет отнять у вас из-за очень удобной рукояти."
	reference = "CH"
...
/datum/uplink_item/dangerous/universal_gun_kit
	...
	desc = "Универсальный набор сборки оружия, который можно комбинировать с любым набором для создания оружия. Для \
			 самостоятельной сборки используются встроенные шестигранные ключи, просто соедините наборы, нажав одним по другому."
	reference = "IKEA"
...
/datum/uplink_item/dangerous/batterer
	...
	desc = "Опасное устройство Синдиката, предназначенное для контроля толпы или организации беспорядков. Вызывает повреждение \
			 мозга, замешательство и другие неприятные эффекты у окружающих пользователя. Имеет 5 зарядов, перезарядка одной активации занимает 20 секунд."
	reference = "BTR"
...
/datum/uplink_item/ammo/pistolap
	...
	desc = "Дополнительный магазин на 8 патронов калибра 10 мм для пистолета Стечкина ФК-69 10мм, заряженный менее эффективными \
...
/datum/uplink_item/ammo/pistolfire
	...
	desc = "Дополнительный магазин на 8 патронов калибра 10 мм для пистолета Стечкина ФК-69 10мм, заряженный зажигательными \
...
/datum/uplink_item/ammo/pistolhp
	...
	desc = "Дополнительный магазин на 8 патронов калибра 10 мм для пистолета Стечкина ФК-69 10мм, заряженный патронами, \
...
/datum/uplink_item/stealthy_weapons/garrote
	...
	desc = "Отрезок волокнистой проволоки, зажатый между двумя деревянными рукоятками - идеальное оружие в руках \
			 осторожного убийцы. При использовании со спины, мгновенно захватывает цель и заставляет замолчать, а также вызывает быстрое удушение. Не работает на тех, кому не нужно дышать."
...
/datum/uplink_item/stealthy_weapons/cameraflash
	name = "Фотовспышка"
	desc = "Вспышка, замаскированная под фотоаппарат, с системой предотвращения перегорания. Имеет автоперезарядку до \
			 5 активных зарядов. Вспышка полезна для того, чтобы ослепить и ошеломить окружающих или отдельных людей, не имеющих средств защиты глаз."
	reference = "CF"
...
/datum/uplink_item/stealthy_weapons/false_briefcase
	...
	desc = "Портфель со скрытым дном позволяющий хранить вещи среднего размера или меньше. Внутрь можно спрятать любое \
			 оружие, что позволит стрелять прямо из портфеля, не вытаскивая оружие. Открутите дно отверткой, вставьте оружие, и закрутите отверткой снова."
	reference = "FBBC"
...
/datum/uplink_item/stealthy_weapons/soap
	...
	desc = "Кусок мыла подозрительного вида который очищает буквально всё за секунду. Окровавленное место убийства или \
			 отпечатки на оружие с этим мылом больше не страшны!"
	reference = "SOAP"
...
/datum/uplink_item/explosives/plastic_explosives
	...
	desc = "Одна из самых распространнёных пластичных композитных взрывчаток. Гарантированно уничтожает объект, на \
			 котором размещенна, в том числе и пол. Имеет настраиваемый таймер с минимальной задержкой до взрыва в 10 секунд. Отлично подходит для избавления от трупов..."
	reference = "C4"
...
/datum/uplink_item/stealthy_tools/forgers_kit
	...
	desc = "Набор, состоящий из штампа и специальной ручки. Штамп может имитировать любую печать, в том числе и официальный \
			 штамп Nanotrasen, с помощью которого можно подделывать документы, а также использовать его в стиральной машине для \
			 создания радужной одежды. Входящая в набор ручка позволяет создавать поддельные подписи, что еще больше расширяет \
			  возможности."
	reference = "FGK"
...
/datum/uplink_item/stealthy_tools/chameleonflag
	...
	desc = "Флаг, который можно замаскировать под любой другой. В древке есть потайное место, куда можно спрятать гранату \
			 или мини-бомбу, которая взорвется через некоторое время после поджёга флага."
	reference = "CHFLAG"
...
/datum/uplink_item/stealthy_tools/chamsechud
	...
	desc = "Украденный ИЛС СБ с внедренной в него технологией маскировки «хамелеон» Синдиката. Подобно маскировочному \
			 комбинезону, ИЛС может превращаться в различные очки, сохраняя при этом свои функции."
	reference = "CHHUD"
...
/datum/uplink_item/stealthy_tools/agent_card
	...
	desc = "Карта агента могжет копировать доступ с других идентификационных карт, суммируя его с уже полученными. \
			 По умолчанию, карта блокирует отслеживание носителя Искусстевенным интелектом через камеры, но не скрывает его."
	reference = "AIDC"
...
/datum/uplink_item/stealthy_tools/chameleon_proj
	...
	desc = "Проецирует изображение на пользователя, маскируя его под отсканированный объект, пока он не выпустит проектор \
			 из рук или маскировки не коснуться. Пользователь в маскировке не может бежать, а снаряды пролетают сквозь него."
	reference = "CP"
...
/datum/uplink_item/stealthy_tools/chameleon_counter
	...
	desc = "Это устройство маскируется под любой объект, который оно сканирует. Маскировка не идеальна, и наблюдатель \
			 может ее заметить."
	reference = "CC"
...
/datum/uplink_item/stealthy_tools/emplight
	name = "EMP Flashlight"
	desc = "Небольшой самозаряжающийся генератор ЭМИ излучения ближнего действия, замаскированный под фонарик. \
...
/datum/uplink_item/device_tools/access_tuner
	...
	desc = "Настройщик доступа — это небольшое устройство, которое может взаимодействовать с воздушными \
			 шлюзами на расстоянии. Подключение занимает несколько секунд. С его помощью можно изменить \
			  состояние блокировки, открыть шлюз или включить аварийный доступ."
	reference = "HACK"
...
/datum/uplink_item/device_tools/surgerybag
	...
	desc = "В сумке находится полный набор хирургических инструментов, смирительная рубашка и намордник. \
			 Сама сумка также изготовлена из очень легких материалов и не будет мешать вам передвигаться, пока вы носите её на спине."
	reference = "SSDB"
...
/datum/uplink_item/device_tools/bonerepair
	...
	desc = "Украденный прототип нанитов для полного восстановления организма. При введении отключает системы организма, \
			 восстанавливая конечности и органы. Восстанавливает органические и кибернетические органы и конечности до состояния \
...
/datum/uplink_item/device_tools/cipherkey
	...
	desc = "Ключ шифрования для подключения к гарнитуре. Позволяет вам прослушивать все каналов отделов станции, \
...
/datum/uplink_item/device_tools/hacked_module
	...
	desc = "При использовании с консолью аплоуда этот модуль позволяет загружить рукописный закон наивысшего \
			 приоритета ИИ станции. Будьте осторожны с его содержанием, поскольку ИИ может искать лазейки в формулировке."
	reference = "HAI"
...
/datum/uplink_item/device_tools/powersink
	...
	desc = "При подключении к электросети и последующем включении это огромное устройство создает чрезмерную нагрузку \
			 на сеть, что приводит к отключению электроэнергии по всей станции. Силовой Поглотитель невозможно переносить \
			  из-за его больших размеров. После оплаты, вы получите небольшой маячок, который при активации телепортирует \
			   Силовой Поглотитель в ваше местоположение."
	reference = "PS"
