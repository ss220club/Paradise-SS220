...
/obj/item/mecha_parts/mecha_equipment/janitor/garbage_magnet
	...
	desc = "Технология блюспейса, интегрированная с увеличенным мусорным мешком и мощными магнитами, позволяет этому устройству подбирать любой мусор. \
	Сложная конструкция мешка предотвращает возможность заглянуть внутрь."
