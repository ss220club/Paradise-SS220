...
/obj/mecha/working/ripley/examine_more(mob/user)
	...
	Вскоре после начала производства Hephaestus передала права на выпуск Ripley другим корпорациям, получая отчисления по мере роста популярности экзокостюма.</i>"
	. += ""
