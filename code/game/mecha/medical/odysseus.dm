...
/obj/mecha/medical/odysseus/examine_more(mob/user)
	...
	Первоначально созданный для спасения и ухода за пациентами в сложных условиях. \
	Он получил высокое распространение в секторе, обычно среди крупных корпораций и военных групп, которые ценят его способность входить и выходить даже из самых трудных зон бедствия.</i>"
	. += ""
	. += "<i>DeForest Medical добилась скромного успеха с экзокостюмом Одиссей, получив лишь незначительные жалобы на его медлительность и недостаток брони или оборонительных возможностей. Несмотря на эти недостатки, он нашёл применение в медицинских командах Nanotrasen, где парамедики находят полезное применение ему и и его разнообразным комплектам оборудования. \
