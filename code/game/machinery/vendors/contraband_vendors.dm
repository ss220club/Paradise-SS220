...
/obj/machinery/economy/vending/hydroseeds/syndicate_druglab
	products = list(
		/obj/item/seeds/ambrosia/deus = 2,
...
/obj/machinery/economy/vending/hydronutrients/syndicate_druglab
	products = list(
		/obj/item/reagent_containers/glass/bottle/nutrient/ez = 12,
...
/obj/machinery/economy/vending/liberationstation
	...
	slogan_list = list(
		"Liberation Station: Ваш универсальный магазин для всех вещей, связанных со второй поправкой!",
	...
	ads_list = list(
		"Пари как космонавт, жаль как пуля!",
	...
	contraband = list(
		/obj/item/clothing/under/costume/patriotsuit = 1,
...
/obj/machinery/economy/vending/toyliberationstation
	...
	contraband = list(
		/obj/item/gun/projectile/shotgun/toy/crossbow = 10, // Congrats, you unlocked the +18 setting!
