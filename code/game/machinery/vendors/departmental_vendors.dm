...
/obj/machinery/economy/vending/hydronutrients
	...
	contraband = list(
		/obj/item/reagent_containers/glass/bottle/ash = 10,
...
/obj/machinery/economy/vending/hydroseeds
	...
	slogan_list = list(
		"ЗДЕСЬ ЖИВУТ СЕМЕНА! ВОЗЬМИТЕ СЕБЕ НЕМНОГО!",
...
/obj/machinery/economy/vending/hydroseeds/perma
	...
	slogan_list = list(
		"You've got nothing better to do. Might as well take up gardening!",
...
/obj/machinery/economy/vending/smith
	...
	products = list(
		/obj/item/smithing_cast/sheet = 6,
