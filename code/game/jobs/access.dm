...
/proc/get_region_accesses(code)
	switch(code)
		...
		if(REGION_ENGINEERING) //engineering and maintenance
			return list(ACCESS_ENGINEERING_GENERAL, ACCESS_MAINT_TUNNELS, ACCESS_ENGINE, ACCESS_ENGINE_EQUIP, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_TECH_STORAGE, ACCESS_ATMOSPHERICS, ACCESS_MINISAT, ACCESS_CE)
