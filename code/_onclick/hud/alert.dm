...
/obj/screen/alert/nocell
	...
	desc = "У юнита отсутствует источник питания. Модули недоступны пока он не будет установлена. Вам смогут помочь робототехники."
	icon_state = "nocell"

/obj/screen/alert/emptycell
	name = "Нет заряда"
	desc = "Источник питания юнита разряжен. Модули недоступны пока он не будет. \
