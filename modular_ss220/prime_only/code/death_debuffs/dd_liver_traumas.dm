/datum/death_debuff/liver_failure
	name = "отказ печени"
...
/datum/death_debuff/liver_failure/dd_effect()
	. = ..()
...
/datum/death_debuff/liver_mailfunction
...
/datum/death_debuff/liver_mailfunction/dd_effect()
	. = ..()
	var/obj/item/organ/organ = H.get_organ_slot(affected_zone)
	if(!organ)
		return
