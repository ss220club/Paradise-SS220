/datum/death_debuff/lungs_failure
...
/datum/death_debuff/lungs_failure/dd_effect()
	. = ..()
...
/datum/death_debuff/lungs_mailfunction
...
/datum/death_debuff/lungs_mailfunction/dd_effect()
	. = ..()
	var/obj/item/organ/organ = H.get_organ_slot(affected_zone)
	if(!organ)
		return
