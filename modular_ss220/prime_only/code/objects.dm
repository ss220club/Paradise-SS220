...
/obj/item/dualsaber/legendary_saber
	name = "Злоба"
	desc = "\"Злоба\" - один из легендарных энергетических мечей Галактики. Является олицетворением самой Тьмы, вызывающей трепетный ужас врагов её владельца. По легенде, \"Злоба\" была собрана своим создателем из чистой и всеобъятной ненависти. Текущий владелец: Миднайт Блэк."
	icon = 'modular_ss220/prime_only/icons/saber.dmi'
	lefthand_file = 'modular_ss220/prime_only/icons/saber_left.dmi'
	righthand_file = 'modular_ss220/prime_only/icons/saber_right.dmi'
...
/obj/item/dualsaber/legendary_saber/flame
	name = "Пламя"
	desc = "\"Пламя\" - один из легендарных энергетических мечей Галактики. Оружие завоевателей. Был создан одной из знатных семей Эллизиума и долгое время являлся их фамильной реликвией. Текущий владелец: Шарлотта Дитерхис."
...
/obj/item/dualsaber/legendary_saber/devotion
	...
	desc = "\"Верность Клятве\" - один из легендарных энергетических мечей Галактики. Это оружие является сакральным символом, обязующим чтить и исполнять данные клятвы. По легендам, в изумрудном свечении клинка отражается душа его создателя. Длительное время был утерян."
...
/obj/item/dualsaber/legendary_saber/sister
	name = "Сестра"
	desc = "\"Светлая Сестра\" - один из легендарных энергетических мечей Галактики. Имеет крайне редкий кристалл с ярко-белым, \"светлым\" свечением. Меч явно создавался под женскую руку и имеет прекрасный баланс. По легендам, в свое время этим мечом был сражен один из лидеров Синдиката - \"Красавка\". Текущий Владелец: Мунивёрс Нормандия."
...
/obj/item/dualsaber/legendary_saber/flee_catcher
	name = "Ловец Бегущих"
	desc = "\"Ловец Бегущих\" - один из легендарных энергетических мечей Галактики. Имеет крайне потрёпанный временем и боями вид. По легендам, своё название клинок заработал на славе известного охотника за головами, отлавливающего беглецов и предателей. Текущий Владелец: Рицу Келли."
...
/obj/item/dualsaber/legendary_saber/aaron
	name = "Звезда Эриды"
	desc = "\"Звезда Эриды\" - один из легендарных энергетических мечей Галактики, самый могущественный по признанию многих мастеров. По легендам, этот меч был создан могучей воительницей, которая вложила в него частичку своей души. Текущий Владелец: Аарон Кандрос. "
