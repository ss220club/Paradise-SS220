/obj/item/clothing/glasses/hud/security/sunglasses/seceyepatch
	name = "секурити повязка"
	desc = "круто"
	...
	sprite_sheets = list(
		...
		"Kidan" = 'modular_ss220/clothing/icons/mob/eyes.dmi',
		...
		"Grey" = 'modular_ss220/clothing/icons/mob/eyes.dmi',
		...
		"Vox" = 'modular_ss220/clothing/icons/mob/eyes.dmi',
		"Drask" = 'modular_ss220/clothing/icons/mob/eyes.dmi',
	)
