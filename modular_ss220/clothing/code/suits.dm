...
/obj/item/clothing/suit/space/deathsquad/officer/field/cloak_nt/red
	...
	desc = "Выдержанный плащ высокопоставленного офицера Нанотрейзен. Сшит из уникальной ткани, сочетающий в себе лёгкость и прочность, идеально подходящий для официальных встреч и выездных мероприятий."
