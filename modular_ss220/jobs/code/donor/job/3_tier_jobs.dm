...
/datum/job/donor/tier_3
	title = "Случайная Т3 роль"
	outfit = /datum/outfit/job/donor/tier_3

/datum/outfit/job/donor/tier_3
	name = "Случайная Т3 роль"
	jobtype = /datum/job/donor/tier_3
