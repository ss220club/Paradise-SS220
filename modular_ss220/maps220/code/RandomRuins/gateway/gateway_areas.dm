...
/area/awaymission/BMPship
	...
	report_alerts = FALSE
	requires_power = FALSE
	ambientsounds = list('sound/music/space.ogg', 'sound/ambience/ambiatmos.ogg', 'sound/ambience/ambigen11.ogg', 'sound/ambience/ambispace.ogg', 'sound/ambience/ambispace2.ogg', 'config/lobby_music/sounds/Traitor.ogg')
