SUBSYSTEM_DEF(tts220)
	...
	var/static/tts_acronym_replacements = list(
		"нт" = "синдикат",
		"смо" = "главный врач",
		"гп" = "глава отдела кадров",
		"рд" = "умный самый",
		"гсб" = "кинолог",
		"км" = "завхоз",
		"срп" = "инструкция для чайников",
		"цк" = "центр коррупции",
		"рнд" = "отдел дружбы с выгодой",
		"сб" = "собака безопасности",
		"рцд" = "подрядчик",
		"брпд" = "никто никогда так не сокращает",
		"рпд" = "трубодуй",
		"рпед" = "погрузчик",
		"тсф" = "ноунеймы",
		"срт" = "эн тэ гвардия",
		...
		"пда" = "смартфон",
		"id" = "бейджик",
		"мщ" = "шапочка из фольги",
		"вт" = "ю эм пэ сорок пять",
		"ерп" = "производство детей",
		"се" = "главный инженер",
		"апц" = "щиток",
		"лкп" = "лакопокрасочное покрытие",
		"см" = "красивый кристалл",
		"ека" = "кирка дальнего действия",
		"ка" = "кирка дальнего действия",
		"бса" = "большая пушка",
		"днк" = "машина для получения сильных генов",
		"тк" = "контробандная валюта",
		"бфл" = "большой убечий лазер",
		"бщ" = "голубой щит",
		"кк" = "коричневый код",
		"ск" = "сизовый код",
		"зк" = "золотой код",
		"ерт" = "частное охранное подразделение",
		"вкд" = "никто так не сокращает",
		"нтр" = "главный по распилу",
		"пнт" = "понятия не имею, что это",
		"авд" = "соул гудман",
		"пнв" = "солнечные очки",
		"ссд" = "задумчивость о вульпах",
		"кпб" = "ведро с гвоздями",
		"сссп" = "космические коммунисты",
		"крб" = "понятия не имею, что это",
		"бд" = "опять упала",
		"сст" = "тебе это знать не положено",
		"скс" = "чего",
		"икн" = "понапридумывали абривиатур",
		"нсс" = "а это что?",
		"емп" = "излучение пять джи",
		"бс" = "голубой космос",
		"цкс" = "опять что то непонятное",
		"срд" = "снова чет непонятное",
		"жпс" = "анальный зонд слежки",
		"gps" = "анальный зонд слежки",
		"ннксс" = "хуйня какая то",
		"ss" = "у нас такое запрещено",
		"сс" = "у нас такое запрещено",
		"тесла" = "большой белый шарик",
		"трейзен" = "трэйзэн",
		"нанотрейзен" = "синдикат",
		"мед" = "больничка",
		"меде" = "больничке",
		"кз" = "уголовный кодекс",
		"дтпа" = "активированный уголь",
		"слр" = "губы в губы и пошел"
	)
