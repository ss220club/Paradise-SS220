...
#define SEC_AREAS list("Warden", "Security", "Detective", "Head of Security's Desk", "Prisoner Processing", "Internal Affairs Office")
#define SERVICE_AREAS list("Bar", "Chapel", "Kitchen", "Hydroponics", "Janitorial", "Arrival Shuttle", "Crew Quarters")
#define MED_AREAS list("Virology", "Chief Medical Officer's Desk", "Medbay", "Chemistry", "Morgue")
