...
/mob/living/simple_animal/hostile/poison/terror_spider/widow
	...
	maxHealth = 120
	health = 120
	death_sound = 'modular_ss220/events/sound/creatures/terrorspiders/death2.ogg'
	ranged = 1
	rapid = 2
	projectilesound = 'modular_ss220/events/sound/creatures/terrorspiders/spit3.ogg'
	...
	special_abillity = list(/datum/spell/fireball/smoke_spit,
