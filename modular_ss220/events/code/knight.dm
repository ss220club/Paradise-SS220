...
/mob/living/simple_animal/hostile/poison/terror_spider/knight
	...
	death_sound = 'modular_ss220/events/sound/creatures/terrorspiders/death1.ogg'
...
/mob/living/simple_animal/hostile/poison/terror_spider/knight/proc/activate_mode(n)
	...
	if	(n==1)
		if(attack_mode_av)
			...
			last_mode = t
			attack_mode_av = 0
			playsound(src, 'modular_ss220/events/sound/creatures/terrorspiders/mod_attack.ogg', 120)
	...
	if	(n==2)
		if(defence_mode_av)
			...
			last_mode = t
			defence_mode_av = 0
			playsound(src, 'modular_ss220/events/sound/creatures/terrorspiders/keratosis_in.ogg', 150)
