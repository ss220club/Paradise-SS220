/obj/item/holosign_creator/atmos
	desc = "Стандартный ATMOS голопроектор. Создаваемые голопроекции полностью блокируют перемещение газов."
	icon = 'modular_ss220/aesthetics/holofan/icons/holofan.dmi'
