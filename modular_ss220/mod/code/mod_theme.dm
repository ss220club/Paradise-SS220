...
/datum/mod_theme/responsory/helldiver
	...
	desc = "Высокотехнологичный боевой MODsuit 'Хеллдайвер', разработанный и произведенный Нанотрейзен. Хорошо бронированный, герметичный, приспособленный под путешествия в областях с агрессивной фауной. \
