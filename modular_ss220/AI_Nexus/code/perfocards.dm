/obj/item/perfocard
	name = "перфокарта"
	desc = "Продолговатая пластина с рядами перфорации и вплавленным шифро-чипом. Судя по всему, что-то экранирует \
	её от банального сканирования."
...
/obj/item/perfocard/proc/generate_perfocard_key()
	// заглушка — потом можно завязать на seed раунда/GUID
	return "[rand(1000, 9999)]-[rand(1000, 9999)]"

/obj/item/perfocard/t2
	name = "перфокарта Т2"
	desc = "Та же перфокарта, но шифр-чип выглядит куда сложнее — похоже, кто-то из отряда быстрого реагирования \
	получил расширенный доступ."
	icon_state = "data"
	access_tier = 2
