...
/obj/machinery/gateway/centerstation/LateInitialize()
	awaygate = locate(/obj/machinery/gateway/centeraway) in SSmachines.get_machinery_of_type(/obj/machinery/gateway/centeraway)
...
/obj/machinery/gateway/centeraway/Initialize()
	..()
	update_icon(UPDATE_ICON_STATE)
	stationgate = locate(/obj/machinery/gateway/centerstation) in SSmachines.get_machinery_of_type(/obj/machinery/gateway/centerstation)
