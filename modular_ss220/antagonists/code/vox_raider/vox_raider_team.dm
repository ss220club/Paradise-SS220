...
/datum/team/vox_raiders_team/proc/get_brother_names_text(datum/mind/brother_to_exclude)
...
/datum/team/vox_raiders_team/proc/pick_meeting_area()
	PRIVATE_PROC(TRUE)
...
/datum/team/vox_raiders_team/proc/forge_single_objective()
	PRIVATE_PROC(TRUE)
