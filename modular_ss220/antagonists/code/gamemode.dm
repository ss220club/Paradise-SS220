/datum/game_mode/can_start()
	...
	if((name in non_repeatable_gamemodes) && (latest_gamemode in non_repeatable_gamemodes))
		return FALSE
	return ..()

/datum/game_mode/proc/get_latest_gamemode() as text
	...
	latest_gamemode = query_latest_gamemode.item[1]
	return latest_gamemode
