/datum/weather/ash_storm/sand_storm
	...
	telegraph_message = "<span class='boldwarning'>Хирка печально известна своими песчаными бурями. Одну из таких вы примечаете на горизонте в виде стремительно нарастающей стены пыли и песка. Стоит поскорее найти укрытие.</span>"
	...
	end_message = "<span class='boldannounceic'>Рёв ветра постепенно стихает, пылевые облака улетучиваются всё дальше и дальше. Опасность миновала.</span>"
