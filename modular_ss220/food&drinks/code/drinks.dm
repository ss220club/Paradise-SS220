...
/datum/reagent/consumable/ethanol/synthanol/restart/on_mob_life(mob/living/carbon/human/M)
	...
	switch(current_cycle)
		...
		if(14)
			playsound(get_turf(M),'modular_ss220/food&drinks/sound/restart-shutdown.ogg', 200, 1)
		if(15 to 23)
			M.Weaken(10 SECONDS)
		...
		if(24)
			playsound(get_turf(M), 'modular_ss220/food&drinks/sound/restart-wakeup.ogg', 200, 1)
		if(25)
			M.SetStunned(0)
			M.SetWeakened(0)
			M.SetParalysis(0)
