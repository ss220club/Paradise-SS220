...
#define ismechaweapon(A) istype(A, /obj/item/mecha_parts/mecha_equipment/weapon)
...
/datum/component/automatic_fire_mecha/Initialize(autofire_shot_delay, windup_autofire, windup_autofire_reduction_multiplier, windup_autofire_cap, windup_spindown, allow_akimbo = TRUE)
	. = ..()
	if(!ismechaweapon(parent))
		return COMPONENT_INCOMPATIBLE
	var/obj/item/mecha_parts/mecha_equipment/gun = parent
...
/datum/component/automatic_fire_mecha/proc/autofire_on(client/user_client)
...
/datum/component/automatic_fire_mecha/proc/windup_reset(deltimer)
