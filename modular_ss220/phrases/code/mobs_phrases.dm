	...
	if(getBrainLoss() >= 60 && stat != DEAD)
		if(prob(3))
			var/list/crazysay = list(
				...
				"ВОССЛАВЬ СОЛНЦЕ!",
				"Я ХОЧУ [pick("СЕБЯ", "ТЕБЯ", "ПОНИ", "ЭТО", "ЕГО", "",
						"КУШАТЬ", "ПИТЬ", "ПИСЯТЬ", "НЕ ХОЧУ", "РАДУЖНЫЙ КАРАНДАШ",
						"ИЗМЕНИТЬ ТЕБЕ", "ОРАТЬ",
						"[pick("УДАРИТЬ", "ОБНЯТЬ", "ПОЦЕЛОВАТЬ", "ЗАДУШИТЬ", "ПОГЛАДИТЬ", "НАКРИЧАТЬ НА", "ИЗБАВИТЬ ОТ СТРАДАНИЙ", "ПОСЛАТЬ", )]
							[pick("ТЕБЯ", "СЕБЯ", "КЛОУНА", "МИМА", "ЩИТКУРА", "ОФИЦЕРА", "ПОВАРА", "МЕДИКА", "КОРОВУ", "САНЮ", )]",
						)]!",
				"МНЕ БОРЩ БЕЗ СВЕКЛЫ!",
				...
				"Безумно можно.",
				"Живи, кайфуй, гуляй, играй, упал - вставай, наглей, ругай, чужих роняй, NT-Windows обновляй, картошка, суп, пельмени, чай.",
				...
				"Я МАШИНА",
				"Я в своем познании настоько преисполнился...",
				...
				"МОЙ ПАПА ГЛАВНЫЙ НА ЦК!!!",
				"МОЙ ПАПА ГЛАВНЫЙ У ТСФ!!!",
				"МОЙ ПАПА ГЛАВНЫЙ У ССП!!!",
				"МОЙ ПАПА ГЛАВНЫЙ У СИНДИКАТА!!!",
				"Мама мыла раму...",
				"Ыыыы...",
				"Ээээ...",
				"ААА ААААА ААААААААА!!!",
			...
			if(prob(95))
				...
				var/list/flipsay = list(
					...
					"Опля!",
					"Але ОП!",
					"Волки в цирке не ступают - а делают сальтуху!",
					"ЗАЦЕНИ!",
					"А ТЫ ТАК СМОЖЕШЬ?!",
				)
				say(pick(flipsay))
