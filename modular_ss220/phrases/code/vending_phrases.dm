...
/obj/machinery/economy/vending/boozeomat/Initialize(mapload)
	...
	slogan_list |= list(
		...
		"Если муравьи поднимают в 10 раз больше своего веса… то 50 грамм муравьев можно послать за бутылкой водки!",
		"После бутылки коньяка беседа превращается в утечку информации.",
		"Лечусь я пивом, мёдом и корицей. Такой вот метод неплохой. Но мёда нет, корицы тоже. Поэтому уже бухой.",
