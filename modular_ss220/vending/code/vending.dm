...
/obj/machinery/economy/vending/nta/medical
	...
	products = list(
		...
		/obj/item/storage/pill_bottle/medipen_case = 5,
		/obj/item/reagent_containers/hypospray/autoinjector/custom/elite/brute = 10,
		/obj/item/reagent_containers/hypospray/autoinjector/custom/elite/burn = 10,
