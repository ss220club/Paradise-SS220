#define automated_end "\[br\]\[br\]\[b\]Слава НТ!\[/b\]\[/center\]\[br\]\[small\]\[i\]Это автоматическое сообщение.\[/i\] \[br\]\[hr\]"
#define not_automated_end "\[br\]\[br\]\[b\]Слава НТ!\[/b\]\[/center\]\[br\]\[small\]\[i\]Это точно не автоматическое сообщение.\[/i\] \[br\]\[hr\]"

#define CC_DEFAULT_FOOTER "\[hr\]\[small\] *Несоблюдение указаний, содержащихся в данном документе, считается нарушением политики корпорации;\[br\]\
